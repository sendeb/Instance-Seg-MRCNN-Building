...
class CustomConfig(Config):
    ...
    # IMAGE_MIN_DIM = 512 # CHANGE
    # IMAGE_MAX_DIM = 512 # CHANGE
    IMAGE_MIN_DIM = 1024 # CHANGE
    IMAGE_MAX_DIM = 1024 # CHANGE
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset, check):
...
def train(model):
    ...
    # import pdb
    # pdb.set_trace()
    dataset_train.load_custom(args.dataset, "train", 2)
    ...
    # import pdb
    # pdb.set_trace()
    dataset_val.load_custom(args.dataset, "val", 2)
    dataset_val.prepare()
